...
<div class="container is-max-widescreen my-4">
    ...
    <section class="item px-3">
        ...
        <div class="item-art is-flex is-align-items-center mt-5">
            ...
            <div class="stars-container is-flex is-justify-content-space-between is-align-items-center ml-3">
            ...
            <div class="rating ml-2">{{  $product->views ?? 0 }}</div>


        </div>
        <div class="item-main  my-5 is-flex is-flex-wrap-wrap is-justify-content-space-around">
            <div class="item-main-gallery  is-flex
            ...
            <div class="item-main__specs  mt-5  is-flex
                ...
                <ul class="mb-4">
                    ...
                    <li>
                        <a class="is-size-7 mt-6 dark-link " href="/">{{__('All characteristics')}} ></a>
                    </li>
                </ul>
                @auth
                ...
                <a class="favorites favorites-item is-flex
                    is-align-items-center " data-category="{{
                    $product->category }}" data-productId="{{$product->id}}" data-status="1">
                    <span class="icon is-size-4 has-text-grey-lighter">
            ...
            <div class="item-main__addtocart   mt-4  is-flex
