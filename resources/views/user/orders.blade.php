        ...
        @foreach( $grouped as $order)
          ...
          is-align-items-center px-4" >
              ...
              is-align-items-flex-start my-3" >
                  ...
                  <span class="order-date my-3" >{{__('Order created')}} : <span >{{ $order[0]->created_at  }}</span ></span >
                ...
                is-align-items-flex-start my-3" >
                  ...
                  <span class="customer-name my-3" >{{__('Customer')}} : <span >{{ $order[0]->username }}</span ></span >
                  <span class="customer-email my-3" >Email : <span >{{ $order[0]->email }}</span ></span >
                  <span class="customer-phone my-3" >{{__('Phone number')}} : <span >{{ $order[0]->phone_number }}</span ></span >
                </div >
              </div >
            ...
            is-align-items-flex-start px-3" >
                ...
                @foreach($order as $product)
                  <div class="product field is-flex   is-align-items-center my-3" >
                    ...
                    <div class="product-quantity px-3" >{{ $product->quantity}}</div >
                    <div class="product-price  px-3" >{{ $product->price/100}}</div >
                    <div class="product-sum  px-3" >{{ $product->quantity * $product->price/100}}</div >
                  </div >
                @endforeach
              </div >
              ...
              is-align-items-stretch my-3" >
                  ...
                  </span > <span >$ {{ number_format($order[0]->sum/100 - 9.44,2,'.',',')}} </span ></div >
