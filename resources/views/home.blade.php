            ...
            <div class="card">
                <a href="{{  $smartphone->category . "/" . $smartphone->id}}">
                    <div class="card-image">
                        <img src="{{ asset('storage/uploads/images/'.$smartphone->id.'/700x700/' . explode(',',$smartphone->images)[0]) }}"
        ...
        <div class="column is-one-fifth-desktop is-one-quarter-tablet is-half-mobile">
            <div class="card">
                <a href="{{  $smartwatch->category . "/" . $smartwatch->id}}">
                    <div class="card-image">
                        <img src="{{ asset('storage/uploads/images/'.$smartwatch->id.'/700x700/' . explode(',',$smartwatch->images)[0]) }}"
    ...
    <div class="container columns is-max-widescreen is-flex">
        ...
        <div class="column subscription-form is-flex is-flex-direction-column is-justify-content-center
            ...
            <div class="is-flex field">
                <label for="email-news-subscription" style="display:none">{{__('Enter your email')}}</label>
                <input class="input" id="email-news-subscription" type="email" name="email"
